    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ...
                // Map View
                NavigationLink(destination: MapView(location: restaurant.location, interaction: [.zoom]).edgesIgnoringSafeArea(.all)) {
                    MapView(location: restaurant.location, interaction:  [.zoom])
                        .frame(minWidth: 0, maxWidth: .infinity)
                        .frame(height: 200)
                        .cornerRadius(10)
                        .padding()
