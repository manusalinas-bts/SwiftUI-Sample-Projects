...
struct RestaurantListView: View {
    ...
    private var isEmpty: Bool {
        !searchText.isEmpty ? restaurantsFiltered.isEmpty : false
    }
    
    
    private var restaurantsFiltered: [Restaurant] {
    ...
    var body: some View {
        NavigationView {
            if isEmpty {
                ...
                List {
                    ForEach(restaurantsFiltered.indices, id: \.self) { index in
                        let restaurant = restaurantsFiltered[index]
                ...
                .listStyle(.plain)
                .navigationTitle("El Rincon Poblano")
        ...
        .searchable(text: $searchText, placement: .navigationBarDrawer(displayMode: .automatic), prompt: "Search Restaurant")
